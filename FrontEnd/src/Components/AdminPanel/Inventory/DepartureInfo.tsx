...
const DepartureInfo = (props: IDepartureInfoProps) => {
  ...
  const handleSelectChange =
    (name: string) => (event: React.ChangeEvent<{}>, value: any) => {
      setFormData((prevNestedObject: IFormData) => ({
        ...prevNestedObject,
        ["departureInfo"]: {
          ...prevNestedObject["departureInfo"],
          [name as string]: {
            city: value?.city ?? "",
            code: value?.code ?? "",
  ...
  const calculateDuration = (name: string, value: string) => {
    ...
    if (differenceInHour === 0 && differenceInMinute < 0) {
      differenceInHour += 24;
      differenceInMinute += 60;
      differenceInHour--;
    } else if (differenceInMinute < 0) {
      differenceInMinute += 60;
      differenceInHour--;
  ...
  return (
    <Accordion defaultExpanded>
      <AccordionSummary
        ...
        aria-controls="departure-info-content"
        id="departure-info-header"
      >
